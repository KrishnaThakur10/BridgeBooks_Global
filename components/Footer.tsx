        ...
        <div className="flex flex-col lg:flex-row justify-between gap-16 mb-20">
          <div className="max-w-md">
            ...
            <div className="flex gap-4">
              <a className="w-8 h-8 rounded-full bg-white border border-gray-200 flex items-center justify-center text-primary hover:text-accent transition-colors" href="#">
